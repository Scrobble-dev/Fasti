...
#[openapi(
    paths(
        ...
        browser_auth::list_passkeys,
        browser_auth::delete_passkey,
        browser_auth::begin_passkey_registration,
        browser_auth::complete_passkey_registration,
        browser_auth::enroll_totp_begin,
        browser_auth::enroll_totp_confirm,
        browser_auth::disable_totp,
        browser_auth::get_oidc_config,
        browser_auth::save_oidc_config,
        browser_auth::delete_oidc_config,
        browser_auth::discover_oidc,
    ...
    components(schemas(
        ...
        fasti_contracts::BeginPasskeyAuthenticationResponse,
        fasti_contracts::BeginPasskeyRegistrationResponse,
        ...
        fasti_contracts::CompletePasskeyAuthenticationRequest,
        fasti_contracts::CompletePasskeyRegistrationRequest,
        fasti_contracts::ConfirmTotpRequest,
        ...
        fasti_contracts::ListPasskeysResponse,
        ...
        fasti_contracts::OidcConfigDto,
        fasti_contracts::OidcDiscoveryRequest,
        fasti_contracts::OidcDiscoveryResponse,
        fasti_contracts::PasskeyDto,
        ...
        fasti_contracts::SaveOidcConfigRequest,
        ...
        fasti_contracts::VerifyTotpRequest,
        ProblemActionDto,
        ProblemDetails,
        ViolationDto
    )),
...
mod tests {
    ...
    fn openapi_is_3_1_and_documents_the_real_routes() {
        ...
        assert_eq!(document.paths.paths.len(), 31);
