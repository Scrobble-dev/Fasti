...
pub const fn public_capability_id(key: CapabilityKey) -> &'static str {
    match key {
        ...
        CapabilityKey::ApplyAnimeGroupingPolicyChange => "profile.anime_grouping_policy.apply",
        ...
        CapabilityKey::PreviewAnimeGroupingPolicyChange => "profile.anime_grouping_policy.preview",
        CapabilityKey::ReadAccessProjection => "access.projection.read",
        CapabilityKey::ReadAnimeGroupingPolicy => "profile.anime_grouping_policy.read",
        ...
        CapabilityKey::ResolveIdentityRoute => "identity.route.resolve",
