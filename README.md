...
- **B4: Product experience** — the Tabler Workbench, browser-account lifecycle, global search, configurable record actions, profile-owned tracking disposition, and trusted-host Google Books/TMDB metadata selection and refresh are active pre-production work; secure poster caching, full settings maturity, and release evidence remain open.
