...
| C1 milestone                  | `cargo xtask test milestone --body C1` writes `target/fasti-receipts/access-c1.json` as the in-scope delivery receipt. It explicitly excludes packaged Tauri authentication.                                                                                                                                                                                                                      | `RUNNER_IMPLEMENTED`; exact-head execution pending       |
