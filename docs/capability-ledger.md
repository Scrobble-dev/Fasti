...
| M3 identity routing and anime grouping policy                                                                | Durable scoped/browser-session HTTP, SDK, and Workbench surfaces; verified IMDb alias routing; bounded impact preview and rollback; Record and Chronicle identity stay unchanged |
