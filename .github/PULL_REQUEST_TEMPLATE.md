...
- [ ] **Tests:** Unit tests, integration tests, or golden fixtures are included.
- [ ] **Accessibility (if UI):** Interactive elements satisfy 44px touch targets and WCAG 2.2 AA standards.
- [ ] **Security:** No unauthenticated endpoints, link-local SSRF vulnerabilities, or unredacted log leaks.

## Test Evidence / Screenshots

<!-- Paste test runner outputs, coverage stats, or UI screenshots here -->
